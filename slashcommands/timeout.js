const durations = [
  {name: "10 secconds", value: 10 * 1000},
  {name: "60 secconds", value: 60 * 1000},
...
module.exports = {
  name: "timeout",
  description: "This is the timeout command for unruly members :)",
  ...
  options: [
    ...
    {
      name: "duration",
      description: "Duration you would like to time out a member",
      type: "NUMBER",
      choices: durations,
      required: true
    },
